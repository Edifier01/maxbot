...
## Latest (2026-08-17)
- **FEATURE-REVIEW-FIX-WAVE4-2026 COMPLETE** — verifier [PASS WITH NOTES](c17b2ac0-bee8-4375-8cf2-e5ab9545413a). Parent pytest **231 passed, 26 skipped**; campaign order 9+9; compose-config and `git diff --check` OK. Agents: campaign [073a26c3](073a26c3-1459-44b9-9494-8ab5ab145415), database [6fcc5e4c](6fcc5e4c-c38f-4851-a5fd-79473b28b733), backend [f02e1cc9](f02e1cc9-8d66-4cc7-a100-0ac84e4f7db8), security [fd3c6e33](fd3c6e33-14a5-4d64-a2cd-344119bf8450), devops [1b3bddc0](1b3bddc0-839c-446d-8b32-a3f3e6167417), frontend [1a307cee](1a307cee-9b34-4bd3-af77-e3c4ea59904e), qa [38dcbb8e](38dcbb8e-a82d-4c0a-838a-02c900425a0c) (blocked sandbox; parent ran tests). Residual: WAL/hot backup not a consistent hybrid snapshot; leftover `.deleting`/`.outgoing-restore` on failed restore. Uncommitted until asked.
- **Self-registration restored** — Compose `${REGISTRATION_OPEN:-1}` and `.env.example=1`. Python `routes_auth` fallback stays `"0"` (unset → 403). Rate limits / JWT / vault untouched. Security [9a765aa5](9a765aa5-9eef-4cd3-b0c0-7a118034b22a); verifier [PASS WITH NOTES](6c42ee13-07bc-45e6-8dcd-d51e2ab90306). Pytest **11 passed, 1 skipped**. Residual: prod `.env` with `REGISTRATION_OPEN=0` must be set to `1` and the app container recreated. Uncommitted until asked.
