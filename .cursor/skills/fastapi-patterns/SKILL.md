...
> **MAX Sender adaptation:** Prefer this project's layout (main.py + app/, hybrid PostgreSQL + per-tenant SQLite, JWT middleware, Fernet vault). Do not force SQLAlchemy/Alembic/RLS/greenfield scaffolds when existing modules already solve the problem. Point to docs/HOW-IT-WORKS.md, ADRs, and AGENTS.md.
