...
> **MAX Sender:** Run scripts from repo root. Stack is **vanilla HTML/CSS** (`maxserver-static-ui`) — use `--stack html-tailwind` for ideas, implement with `:root` CSS variables, not Tailwind classes.
